...
static inline const usb_standard_desc_t *next_report_descriptor(const usb_standard_desc_t *desc, size_t len, size_t *offset) 
{
    return usb_parse_next_descriptor_of_type(desc, len, HID_CLASS_DESCRIPTOR_TYPE_REPORT, (int *)offset);
}
